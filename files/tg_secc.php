...
<li><a href="contribution.php<?php echo $url; ?>">投稿</a></li>
  ...
  <div class="content"><!-- InstanceBeginEditable name="EditRegion1" -->
    <p>投稿成功！您可在<a href='../admin/zcxx.php?username=".$username."'>注册信息</a>中查看您的投稿动态。<a href="javascript:window.history.back();"><img src="../images/back.jpeg" width="20" height="22" />返回</a></p><!-- InstanceEndEditable -->
  <!-- end .content --></div>
  <div class="footer">
