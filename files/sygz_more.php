...
mysql_select_db($database_conn, $conn);
$query_rs2 = sprintf("SELECT * FROM poetry WHERE id = %s", GetSQLValueString($colname_rs2, "int"));
...
<li><a href="contribution.php<?php echo $url; ?>">投稿</a></li>
  ...
  <div class="content"><!-- InstanceBeginEditable name="EditRegion1" --><h1>诗意广州</h1><div class="back"><a href="javascript:window.history.back();"><img src="../images/back.jpeg" width="20" height="22" />返回</a></div>
    <h2><?php echo $row_rs2['title']; ?></h2>
    <h4>【作者】<?php echo $row_rs2['poet']; ?>    【朝代】<?php echo $row_rs2['dynasty']; ?></h4>
    <hr width="90%">
    <h3><?php echo $row_rs2['content']; ?></h3>
    <div id="TabbedPanels1" class="TabbedPanels">
      <ul class="TabbedPanelsTabGroup">
        <li class="TabbedPanelsTab" tabindex="0">格律</li>
        <li class="TabbedPanelsTab" tabindex="0">译文</li>
      </ul>
      <div class="TabbedPanelsContentGroup">
        <div class="TabbedPanelsContent"><?php echo $row_rs2['meter']; ?></div>
        <div class="TabbedPanelsContent">
          <?php if ($totalRows_rs2 > 0) { // Show if recordset not empty ?>
            <p><?php echo $row_rs2['translation']; ?></p>
            <?php } // Show if recordset not empty ?>
          <?php if ($row_rs2['translation'] == "") { // Show if recordset empty ?>
  <p>暂无内容</p>
  <?php } // Show if recordset empty ?>
        </div>
      </div>
    ...
    <p class="block">赏析</p>
    <?php if ($totalRows_rs2 > 0) { // Show if recordset not empty ?>
      <p><?php echo $row_rs2['appreciation']; ?></p>
      <?php } // Show if recordset not empty ?>
    <?php if ($row_rs2['appreciation'] == "") { // Show if recordset empty ?>
      <p>暂无内容</p>
      <?php } // Show if recordset empty ?>
	  <p><?php echo $row_rs2['more']; ?></p>
<script type="text/javascript">
