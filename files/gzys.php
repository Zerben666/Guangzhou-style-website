...
<li><a href="contribution.php<?php echo $url; ?>">投稿</a></li>
  ...
  <div class="content"><!-- InstanceBeginEditable name="EditRegion1" -->
    <h1>广州元素</h1>
    <div class="img">
      <div class="divcss"><a href="gsdh.php<?php echo $url;?>" title="广式动画"><img src="../images/wuliuqi.jpg" width="201" height="217"></a>
      <span>刺客伍六七</span>
      </div>
      <p><a href="gsdh.php<?php echo $url;?>">广式动画</a></p>
    </div><div class="img">
      <div class="divcss"><p><a href="jlgz.php<?php echo $url;?>" title="记录广州"><img src="../images/camera.jpg" width="258" height="217"></a></p><span>纪录片里的广州</span></div>
      <p><a href="jlgz.php<?php echo $url;?>">记录广州</a></p>
    </div><div class="img">
      <div class="divcss"><p><a href="sygz.php<?php echo $url;?>" title="广府诗歌"><img src="../images/poetry.jpg" width="234" height="217"></a></p><span><a href="sygz_more.php?id=1<?php if($row_rs['username']!=""){echo "&"."username=".$row_rs['username'];} ?>" title="《归雁》">《归雁》</a></span></div>
      <p><a href="sygz.php<?php echo $url;?>">广府诗歌</a></p>
    </div>
  <!-- InstanceEndEditable -->
  <!-- end .content --></div>
  <div class="footer">
