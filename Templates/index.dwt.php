...
<li><a href="../files/contribution.php<?php echo $url; ?>">投稿</a></li>
  ...
  <div class="content"><!-- TemplateBeginEditable name="EditRegion1" --><h1>说明</h1>
    ...
    <p>要删除内嵌样式，请确保将 CSS 样式面板设置为“当前”。选择图像，然后在“CSS 样式”面板的“属性”窗格中右键单击并删除显示和背景属性。（当然，您始终可以直接访问代码，并在其中删除图像或占位符的内嵌样式。）</p><!-- TemplateEndEditable -->
  <!-- end .content --></div>
  <div class="footer">
    <p>脚注</p>
    <!-- end .footer --></div>
