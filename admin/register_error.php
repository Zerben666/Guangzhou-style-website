...
<li><a href="../files/contribution.php<?php echo $url; ?>">投稿</a></li>
  ...
  <div class="content"><!-- InstanceBeginEditable name="EditRegion1" -->
    <p>注册失败，请<a href="register.php">重新注册</a></p>
    <div id="CollapsiblePanel1" class="CollapsiblePanel">
      <div class="CollapsiblePanelTab" tabindex="0">可能的原因</div>
      <div class="CollapsiblePanelContent">
        <ol>
          <li>信息不完善
            <ul>
              <li>昵称未填</li>
              <li>注册方式未选账号注册却不填注册邮箱或注册手机</li>
            </ul>
          </li>
    ...
    <div id="CollapsiblePanel2" class="CollapsiblePanel">
      <div class="CollapsiblePanelTab" tabindex="0">我们的建议</div>
      <div class="CollapsiblePanelContent">
        <ol>
          <li>建议使用微软<a href="https://www.microsoft.com/zh-cn/edge?r=1" title="没有这个浏览器？去下载" target="_blank">Edge浏览器</a>浏览本站；</li>
          <li>建议给你的帐号指定一个好听的昵称（不推荐用默认的昵称）；</li>
          <li>输入尽可能多的信息并保证它们的有效性；</li>
          <li>设置密保问题以防忘记密码；</li>
          <li>尽量设置独立密码（不要多个网站使用同一密码）、提高密码复杂度，以提高安全性；</li>
          <li>不要重复注册。</li>
        </ol>
      </div>
    </div>
