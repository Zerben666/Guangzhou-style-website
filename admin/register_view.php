...
<title>广州风情|注册成功</title>
<!--旧的自动跳转<meta http-equiv="refresh" content="10;url=login.php">-->
<!-- InstanceEndEditable -->
...
<li><a href="../files/contribution.php<?php echo $url; ?>">投稿</a></li>
  ...
  <div class="content"><!-- InstanceBeginEditable name="EditRegion1" -->
    <p>恭喜您，注册成功！将在<input type="text" readonly value="10"  size="3" id="time">秒内跳转到<a href="login.php">登录页面</a>，登陆后您可进行评论或进入您的注册信息页修改详细信息。</p>
